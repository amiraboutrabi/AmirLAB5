...
public class MainActivity extends AppCompatActivity {
    ...
    public void getDataByAsyncTask(){
        ...
        }.execute(Constants.GUNFIRE_URL) .execute(Constants.FLOATRATES_API_URL) .execute(Constants.METEOLT_API_URL) ;
    }
    ...
    public void getDataByThread() {
        ...
        Runnable getDataAndDisplayRunnable = new Runnable() {
            ...
            public void run() {
                try {
                    final List result = ApiDataReader.getValuesFromApi1(Constants.FLOATRATES_API_URL);
